...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    vnavTrainingAuthUserSubject.add(
      VnavTrainingAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<VnavTrainingAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  VnavTrainingAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = VnavTrainingAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    vnavTrainingAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
VnavTrainingAuthUser? currentUser;
